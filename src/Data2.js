        ...
        packhouse: [
            {
                ...
                id: id++,
                weeks: "Week 11 en 12",
                opdracht: "in de 11de en 12de week heb ik aan kamer 4 puzzle lopen werken. het probleem was dat het slpen van de papieren snippers niet zo makkelijk meesleepte, dus om dat op te lossen heb ik ze wat dichterbij de puzzel neergelegd en geprobeerd om de slepen wat beter te maken, maar uit eindelijk moest ik er mee stoppen omdat de puzzel ook opnieuw gemaakt moet worden voor dat en dat zou te veel tijd kosten als ik er aan zou gaan zitten. De X-cube is nu ook in portugal gevestiged, dus wij waren eventjes bezig met de portugese vertaling in sommige games. Het probleem hier was dat de papieren snippers hun oude posities moesten onthouden en dan ook andere kon vervangen, maar dat werkte niet zo goed dus hebben we het voor nu laten zitten.",
                img: dragging,
